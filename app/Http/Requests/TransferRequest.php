...
class TransferRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'numberAccountDestination' => 'required|integer',
    ...
    public function messages(): array
    {
        return [
            ...
            'numberAccountDestination.required' => 'A conta de destino é obrigatória',
            'numberAccountDestination.integer' => 'A conta de destino deve ser um número inteiro',
            'value.required' => 'O valor é obrigatório',
            'value.numeric' => 'O valor deve ser um número',
            'type.required' => 'O tipo é obrigatório',
            'type.string' => 'O tipo deve ser uma string',
            'type.in' => 'O tipo deve ser transfer',
